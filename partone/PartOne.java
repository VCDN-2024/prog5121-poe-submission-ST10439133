...
public class PartOne 
{
    ...
    public static void main(String[] args) 
    {
        ...
        tasks.taskMenu();
        tasks.addTask(Surname, 0, makeUsername, makeUsername, 0, Surname);
        tasks.checkTaskDescription(Surname);
        tasks.createTaskID(Name);
        tasks.deleteTask();
        tasks.developerTasks();
        tasks.displayCompletedTasks();
        tasks.longestDuration();
        tasks.searchTaskName();
        tasks.displayReport();
        tasks.functionMenu();
        tasks.displayDevelopers(args);
